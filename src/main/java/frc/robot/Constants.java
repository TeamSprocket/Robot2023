...
public class Constants {
    ...
    public static final class Auton { 
        ...
        public static final double kPBalance = 0.0001; //0.08
        public static final double kIBalance = 0;
        public static final double kDBalance = 0.00;
        public static final double BALANCE_END_TIME_THRESHOLD = 1;
        ...
        public static final double kPDriveToTargetXY = 0.001;
        public static final double kIDriveToTargetXY = 0.0;
        public static final double kDDriveToTargetXY = 0.0;
        

        public static final double kPDriveToTargetT = 0.001;
