...
import frc.robot.RobotMap.LEDStrip;
	...
	public final class RobotContainer {
		...
		public Command getAutonomousCommand() {
			...
			// 			new DeportArm(elevator, arm, wrist, last),
			// 			new SetHighTimed(elevator, arm, wrist, 2),
			// 			new SwerveDriveCmdTimed(swerveDrive, new Pose2d(0.0, -0.3, new Rotation2d(0.0)), 3), //4
			// 			new SwerveDriveCmdTimed(swerveDrive, new Pose2d(0.0, 0.1, new Rotation2d(0.0)), 0.5), //4
			// 			new LimelightAlignTimed(swerveDrive, 3)
			// 		),
			// 		new RollClawTimed(claw, 0.25, 9.4)
			// 	),
			// 	new RollClawTimed(claw, -1, 1),
			// 	new SwerveDriveCmdTimed(swerveDrive, new Pose2d(0.0, 0.5, new Rotation2d(0.0)), 5) //4
			...
			// 	)
				...
				// 	new SwerveDriveCmdTimed(swerveDrive, new Pose2d(0.0, -0.75, new Rotation2d(0.0)), 2.5),
				// 	new RollClawTimed(claw, -0.8, 2)
				// ),
				// new ParallelCommandGroup(
				// 	new SetHomeTimed(elevator, arm, wrist, 2),
				// 	new RollClawTimed(claw, -0.5, 2)
				// )
			// ));
			// 	new OneMeterForward(swerveDrive)
			// ));
