...
public class SetHighCube extends CommandBase {
  ...
  public SetHighCube(Elevator elevator, Arm arm, Wrist wrist) {
  ...
  public void execute() {
    ...
    if (!elevator.reachedClearHeight()) {
      ...
      elevator.setState(ElevatorStates.HIGH_CUBE);
      arm.setState(ArmStates.HIGH_CUBE);
      wrist.setState(WristStates.HIGH_CUBE);
    }
  }
