...
// public class AutonTester extends SequentialCommandGroup {
//   public AutonTester(SwerveDrive swerveDrive, Elevator elevator, Arm arm, Wrist wrist, Claw claw) {
//     addCommands(
//         new SwerveDriveCmdTimed(swerveDrive, new Pose2d(0.5, 0.0, new Rotation2d(0.0)), 1)
//     );
