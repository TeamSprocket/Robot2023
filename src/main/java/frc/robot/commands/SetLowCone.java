...
public class SetLowCone extends CommandBase {
  Elevator elevator;
  Arm arm;
  Wrist wrist;
  ...
  public void execute() {
    ...
    if (!elevator.reachedClearHeight()) {
      ...
      elevator.setState(ElevatorStates.LOW_CONE);
      arm.setState(ArmStates.LOW_CONE);
      wrist.setState(WristStates.LOW_CONE);
    }
  }
