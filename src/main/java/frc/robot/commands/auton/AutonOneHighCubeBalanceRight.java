...
public class AutonOneHighCubeBalanceRight extends SequentialCommandGroup {
  public AutonOneHighCubeBalanceRight(SwerveDrive swerveDrive, Elevator elevator, Arm arm, Wrist wrist, Claw claw) {
    ...
    addCommands(
      ...
      // Score cube
        ...
        new SwerveDriveCmdTimed(swerveDrive, new Pose2d(0.75, 0.0, new Rotation2d(0.0)), 0.5),
        // new SwerveDriveCmdTimed(swerveDrive, new Pose2d(0.0, -0.75, new Rotation2d(0.0)), 2),
        new BalanceOnChargeStationGyro(swerveDrive, 0.06, true, 6.0),
