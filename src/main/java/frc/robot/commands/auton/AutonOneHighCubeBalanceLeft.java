...
public class AutonOneHighCubeBalanceLeft extends SequentialCommandGroup {
  public AutonOneHighCubeBalanceLeft(SwerveDrive swerveDrive, Elevator elevator, Arm arm, Wrist wrist, Claw claw) {
