...
public class AutonOneHighCubeOneStowCube extends SequentialCommandGroup {
  public AutonOneHighCubeOneStowCube(SwerveDrive swerveDrive, Elevator elevator, Arm arm, Wrist wrist, Intake intake) {
    ...
    addCommands(
      new SequentialCommandGroup(
        ...
        new ParallelCommandGroup(
            ...
            new RollIntakeTimed(intake, -0.2, 3)
        ),
        
        // High bloop
        new ParallelCommandGroup(
          new RollIntakeTimed(intake, 0.25, 0.25),
        ...
        new ParallelCommandGroup(
          ...
          new RollIntakeTimed(intake, -0.5, 1.5),
