...
public class AutonHighOneCubeNoTaxiRight extends SequentialCommandGroup {
  public AutonHighOneCubeNoTaxiRight(SwerveDrive swerveDrive, Elevator elevator, Arm arm, Wrist wrist, Intake intake) {
