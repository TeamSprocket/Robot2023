...
public class AutonTwoCubeBalance extends SequentialCommandGroup {
  public AutonTwoCubeBalance(SwerveDrive swerveDrive, Elevator elevator, Arm arm, Wrist wrist, Claw claw) {
