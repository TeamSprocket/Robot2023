...
public final class RobotMap {
  ...
  public static final class Drivetrain {
    ...
    public static final int FRONT_RIGHT_ABS_ENCODER_ID = 2;
    public static final int BACK_LEFT_ABS_ENCODER_ID = 3;
    public static final int BACK_RIGHT_ABS_ENCODER_ID = 4;
