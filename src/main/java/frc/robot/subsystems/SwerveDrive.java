...
public class SwerveDrive extends SubsystemBase {
    ...
    public void zeroTurnABS() {
        frontLeft.resetTurnABS(0.0);
        frontRight.resetTurnABS(0.0);
        backLeft.resetTurnABS(0.0);
        backRight.resetTurnABS(0.0);
    }
    public void zeroTurnABSManual(double[] readings) {
        frontLeft.resetTurnABS(0.0, readings[0]);
        frontRight.resetTurnABS(0.0, readings[1]);
        backLeft.resetTurnABS(0.0, readings[2]);
        backRight.resetTurnABS(0.0, readings[3]);
    }

    public double[] getTurnResetTicks() {
        double[] resetTicks = {
            frontLeft.getTurnResetTicks(),
            frontRight.getTurnResetTicks(),
            backLeft.getTurnResetTicks(),
            backRight.getTurnResetTicks()
        };
        return resetTicks;
